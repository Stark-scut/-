...
<div class="container-fluid">
	...
	<div>
		<form class="form-inline" method="post" action="http://localhost:8080/KFC/adminType/typeAdd">
		...
		<c:forEach items="${list }" var="t">
			<tr>
				...
				<td>
					...
					<a class="btn btn-danger" href="http://localhost:8080/KFC/adminType/typeDelete?id=${t.id }">删除</a>
				</td>
			</tr>
		</c:forEach>
