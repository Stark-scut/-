		...
		<c:forEach items="${p.list }" var="u">
			<tr>
				...
				<td>
					...
					<a class="btn btn-primary" href="http://localhost:8080/KFC/adminUser/userEditShow?id=${u.id }">修改</a>
					<a class="btn btn-danger" href="http://localhost:8080/KFC/adminUser/userDelete?id=${u.id }">删除</a>
				</td>
			</tr>
		</c:forEach>
