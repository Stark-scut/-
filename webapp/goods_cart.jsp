	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<a href="http://localhost:8080/KFC/goods/goodsDetail?id=${item.key}">
								<img src="${pageContext.request.contextPath }/${item.value.goods.cover}" class="img-responsive">
							</a>
						</div>
						<div class="cart-item-info">
							<h3><a href="http://localhost:8080/KFC/goods/goodsDetail?id=${item.key}">${item.value.goods.name}</a></h3>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="http://localhost:8080/KFC/order/orderSubmit">提交订单</a>
			</div>
