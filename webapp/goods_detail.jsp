...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<%=basePath%>css/flexslider.css">
		...
		<div class="container">
			<div class="single-grids">				
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					<h3>${g.name}</h3>
					<div class="tag">
						<p>分类 : <a href="http://localhost:8080/KFC/goods/GoodsList?typeid=${g.type.id}">${g.type.name}</a></p>
					</div>
					<p>${g.intro}</p>
					<div class="galry">
						<div class="prices">
				...
				<div class="col-md-4 single-grid1">
					<!-- <h2>商品分类</h2> -->
					<ul>
                        <li><a  href="http://localhost:8080/KFC/goods/GoodsList">全部系列</a></li>

                        <c:forEach items="${typeList}" var="t">
                            <li><a href="http://localhost:8080/KFC/goods/GoodsList?typeid=${t.id}">${t.name}</a></li>
                        </c:forEach>
					</ul>
				</div>
				<div class="clearfix"> </div>
