...
<div class="products">
    <div class="container">
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            ...
                            <div class="b-wrapper">
                                <h4 class="b-animate b-from-left  b-delay03">
                                    <button href="http://localhost:8080/KFC/goods/goodsDetail?id=${g.id}">查看详情</button>
                                </h4>
                            </div>
                        </div>
                    </a>
        ...
        <jsp:include page="page.jsp">
            <jsp:param name="url" value="http://localhost:8080/KFC/goods/goodsRecommendList"></jsp:param>
